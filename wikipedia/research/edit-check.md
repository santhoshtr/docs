...
- For many models, we filter out list articles and disambiguation pages because the predictions often are not relevant given how different these articles are from the standard article. Maybe less "harm" and more about noise/frustration for editors. This can be done in a few ways:
